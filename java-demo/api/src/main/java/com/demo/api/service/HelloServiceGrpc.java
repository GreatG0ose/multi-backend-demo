...
@javax.annotation.Generated(
    ...
    comments = "Source: service/hello.proto")
...
public final class HelloServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.demo.api.model.PersonOuterClass.Person,
      com.demo.api.service.Hello.GreetResponse> getGreetMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Greet",
      requestType = com.demo.api.model.PersonOuterClass.Person.class,
      responseType = com.demo.api.service.Hello.GreetResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.demo.api.model.PersonOuterClass.Person,
      com.demo.api.service.Hello.GreetResponse> getGreetMethod() {
    io.grpc.MethodDescriptor<com.demo.api.model.PersonOuterClass.Person, com.demo.api.service.Hello.GreetResponse> getGreetMethod;
    if ((getGreetMethod = HelloServiceGrpc.getGreetMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getGreetMethod = HelloServiceGrpc.getGreetMethod) == null) {
          HelloServiceGrpc.getGreetMethod = getGreetMethod =
              io.grpc.MethodDescriptor.<com.demo.api.model.PersonOuterClass.Person, com.demo.api.service.Hello.GreetResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Greet"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.demo.api.model.PersonOuterClass.Person.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.demo.api.service.Hello.GreetResponse.getDefaultInstance()))
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void greet(com.demo.api.model.PersonOuterClass.Person request,
        io.grpc.stub.StreamObserver<com.demo.api.service.Hello.GreetResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.demo.api.model.PersonOuterClass.Person,
                com.demo.api.service.Hello.GreetResponse>(
                  this, METHODID_GREET)))
          .build();
    }
  }
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloServiceBlockingStub> {
    ...
    /**
     */
    public com.demo.api.service.Hello.GreetResponse greet(com.demo.api.model.PersonOuterClass.Person request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HelloServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.demo.api.service.Hello.GreetResponse> greet(
        com.demo.api.model.PersonOuterClass.Person request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GREET:
          serviceImpl.greet((com.demo.api.model.PersonOuterClass.Person) request,
              (io.grpc.stub.StreamObserver<com.demo.api.service.Hello.GreetResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.demo.api.service.Hello.getDescriptor();
    }
